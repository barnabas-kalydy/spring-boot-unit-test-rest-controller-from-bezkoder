...
public class TutorialControllerTests {
  ...
  void shouldReturnListOfTutorials() throws Exception {
    List<Tutorial> tutorials = Arrays.asList(new Tutorial(1, "Spring Boot @WebMvcTest 1", "Description 1", true),
  ...
  void shouldReturnListOfTutorialsWithFilter() throws Exception {
    List<Tutorial> tutorials = Arrays.asList(new Tutorial(1, "Spring Boot @WebMvcTest", "Description 1", true),
